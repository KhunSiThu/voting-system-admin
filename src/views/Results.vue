...
<div v-if="voteResultsWholeKing.length > 0 && voteResultsMajorQueen.length > 0" class="sm:ml-64 bg-gray-100 text-gray-900 rounded-lg dark:bg-gray-900 dark:text-gray-200 min-h-screen">
    ...
    <section class="py-8 px-4">
        ...
        <ShowResult v-if="wholeShow" title="Over All Results" table="whole" :allResults="allResults" :king="king.whole" :queen="queen.whole" :resultsKing="voteResultsWholeKing" :resultsQueen="voteResultsWholeQueen"></ShowResult>
...
import getAllVote from '@/composables/getAllvote';
...
export default {
    ...
    setup() {
        ...
        const fetchResults = async () => {
           ...
           getAllVote ("voteWholeKing", (results) => {
                voteResultsWholeKing.value = results;
                updateTopCandidates();
            });

           getAllVote ("voteWholeQueen", (results) => {
