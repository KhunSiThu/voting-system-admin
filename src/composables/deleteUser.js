...
const deleteUser = async (table,studentId) => {
    try {
        ...
        const voteWholeKingRef = db.collection("voteWholeKing");
        const voteWholeQueenRef = db.collection("voteWholeQueen");
        ...
        await removeVoterFromCollection(voteWholeKingRef);
        await removeVoterFromCollection(voteWholeQueenRef);
